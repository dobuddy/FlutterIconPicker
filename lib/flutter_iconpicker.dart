...
Future<IconPickerIcon?> showIconPicker(
  ...
  configuration = configuration.copyWith(
    ...
    iconPickerShape: configuration.iconPickerShape ?? RoundedRectangleBorder(borderRadius: BorderRadius.circular(5.0)),
    backgroundColor: configuration.backgroundColor ?? Theme.of(context).dialogBackgroundColor,
  );
  ...
  if (configuration.adaptiveDialog) {
    if (MediaQuery.of(context).size.width >= configuration.constraints!.maxWidth) {
